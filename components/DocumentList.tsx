      ...
      <div className="max-w-7xl mx-auto space-y-10 animate-in fade-in pb-12">
         ...
         <div className="flex flex-col md:flex-row justify-between items-end md:items-center gap-6">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
               <div className="hidden md:flex bg-white p-1 rounded-xl shadow-sm border border-slate-100 items-center">
               ...
               <button
                  onClick={onCreateNew}
                  className="flex-1 md:flex-none bg-[#1c2938] text-white px-6 py-4 md:py-3.5 rounded-2xl font-bold hover:bg-[#27bea5] transition-all flex items-center justify-center gap-2 shadow-xl group active:scale-95"
               >
            ...
            <div className="bg-white p-4 md:p-6 rounded-[1.5rem] md:rounded-[2rem] shadow-sm border border-slate-50 relative overflow-hidden group hover:shadow-md transition-all">
               ...
               <div className="relative z-10">
                  <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
                     <div className="p-2 bg-green-50 text-green-600 rounded-lg md:rounded-xl"><Wallet className="w-4 h-4 md:w-6 md:h-6" /></div>
                     <span className="hidden xs:flex text-[10px] md:text-xs font-bold text-green-600 bg-green-50 px-1.5 md:px-2 py-0.5 rounded-full items-center"><ArrowUpRight className="w-2.5 h-2.5 md:w-3 md:h-3 mr-1" /> Real</span>
                  </div>
                  <p className="text-slate-400 text-[10px] md:text-xs font-bold uppercase tracking-widest">Impacto Real</p>
                  <h3 className="text-lg md:text-2xl font-bold text-[#1c2938] mt-0.5 md:mt-1 tracking-tight">{currencySymbol} {totalPaid.toLocaleString()}</h3>
               </div>
            </div>
            <div className="bg-white p-4 md:p-6 rounded-[1.5rem] md:rounded-[2rem] shadow-sm border border-slate-50 relative overflow-hidden group hover:shadow-md transition-all">
               ...
               <div className="relative z-10">
                  <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
                     <div className="p-2 bg-amber-50 text-amber-600 rounded-lg md:rounded-xl"><Clock className="w-4 h-4 md:w-6 md:h-6" /></div>
                  </div>
                  <p className="text-slate-400 text-[10px] md:text-xs font-bold uppercase tracking-widest">Por Cobrar</p>
                  <h3 className="text-lg md:text-2xl font-bold text-[#1c2938] mt-0.5 md:mt-1 tracking-tight">{currencySymbol} {totalPending.toLocaleString()}</h3>
               </div>
            </div>
            <div className="bg-white p-4 md:p-6 rounded-[1.5rem] md:rounded-[2rem] shadow-sm border border-slate-50 relative overflow-hidden group hover:shadow-md transition-all">
               ...
               <div className="relative z-10">
                  <div className="flex items-center gap-2 md:gap-3 mb-2 md:mb-4">
                     <div className="p-2 bg-purple-50 text-purple-600 rounded-lg md:rounded-xl"><FileBadge className="w-4 h-4 md:w-6 md:h-6" /></div>
                  </div>
                  <p className="text-slate-400 text-[10px] md:text-xs font-bold uppercase tracking-widest">Pipeline</p>
                  <h3 className="text-lg md:text-2xl font-bold text-[#1c2938] mt-0.5 md:mt-1 tracking-tight">{currencySymbol} {totalPipeline.toLocaleString()}</h3>
               </div>
            </div>
            ...
            <div className="bg-[#1c2938] p-4 md:p-6 rounded-[1.5rem] md:rounded-[2rem] shadow-lg relative overflow-hidden group text-white">
               ...
               <div className="relative z-10 h-full flex flex-col justify-between">
                  <div className="flex items-center justify-between mb-2 md:mb-4">
                     ...
                     {isLoadingInsight && <Loader2 className="w-3 h-3 md:w-4 md:h-4 animate-spin text-[#27bea5]" />}
                  </div>
                  <div>
                     <p className="text-slate-400 text-[10px] md:text-xs font-bold uppercase tracking-widest mb-0.5 md:mb-1">Tendencia</p>
                     {invoices.length > 0 ? (
                        <>
                           <h3 className="text-sm md:text-lg font-bold leading-tight mb-0.5 md:mb-1 flex items-center gap-1.5 md:gap-2">
                              <span className="truncate">{revenueTrend.percentageChange > 0 ? 'Subiendo' : (revenueTrend.percentageChange < 0 ? 'Bajando' : 'Igual')}</span>
                              <span className={`text-[9px] md:text-xs px-1 md:px-2 py-0.5 rounded border ${revenueTrend.percentageChange >= 0 ? 'bg-green-500/20 text-green-400 border-green-500/30' : 'bg-red-500/20 text-red-400 border-red-500/30'}`}>
                                 {revenueTrend.percentageChange > 0 ? '+' : ''}{revenueTrend.percentageChange.toFixed(0)}%
                              </span>
                           </h3>
                           <p className="hidden xs:block text-[9px] md:text-xs text-[#27bea5] font-medium mt-1 leading-snug opacity-90 truncate">
                              {isLoadingInsight ? '...' : (aiInsight || "IA Lista")}
                           </p>
                        </>
                     ) : (
